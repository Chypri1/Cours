...
int fonction_bandeau_ville(SDL_Rect cases[LONGUEUR_CASE][LARGEUR_CASE], SDL_Renderer *renderer,ville_t *ville,SDL_Texture* texture);
...
int fonction_bandeau_archer(SDL_Rect cases[LONGUEUR_CASE][LARGEUR_CASE], SDL_Renderer *renderer,arm_long_t *arm_long,int liste_cases[N][N],  SDL_Texture* texture);
